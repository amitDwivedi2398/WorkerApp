...
const FavoriteScreen = ({navigation}) => {
    ...
    const getBrachbyHospital = async () => {
        axios
            .get(
                `http://WorkerApp.in/newadmin/api/ApiCommonController/favoritebasedonuserid/${storeddata}`,
            )
            .then(response => {
    ...
    const remove = async (id)=>{
        axios.post(`http://WorkerApp.in/newadmin/api/ApiCommonController/deletefavorite11`,
        {
            fav:id
        },
        {
